    ...
    <div class="col-md-4 order-md-2 mb-4">
        ...
        <ul class="list-group mb-3">
            ...
            <li class="list-group-item d-flex justify-content-between lh-condensed">
                ...
                <span class="text-muted">{{$product['product_total']}} DH</span>
            </li>
            @endforeach
    ...
    <div class="col-md-8 order-md-1">
        ...
        <form action="{{route('order')}}" method="POST" class="needs-validation" novalidate>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="address" class="form-control" id="address" placeholder="33 Av. Mohamed V" required>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" name="zip" class="form-control" id="zip" placeholder="24000" required>
                    <div class="invalid-feedback">
                        Zip code required.
                    </div>
                </div>
