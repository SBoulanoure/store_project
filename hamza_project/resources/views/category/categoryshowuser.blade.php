...
@section('content')
    ...
    <div class = "products">
        <div class = "container">
            <h1 class = "lg-title"><i>Category : <span style="color: #2d995b;">{{$category->cat_name}}</span></i></h1>
                    ...
                    <div class = "product">
                        ...
                        <div class = "product-info">
                            ...
                            @if($product->sale_price >0)
                                ...
                                <p class = "product-price">DH {{$product->sale_price}}</p>
                            @else
                                <p class = "product-price">DH {{$product->price}}</p>
                            @endif
                        </div>
