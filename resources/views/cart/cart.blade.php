        ...
        <div class="row">
            <div class="col-md-8 cart">
                ...
                <div class="row border-top border-bottom">
                    <div class="row main align-items-center">
                        ...
                        <div class="col">{{$product['product_total']}} DH
            ...
            <div class="col-md-4 summary">
                ...
                <div class="row">
                    ...
                    <div class="col text-right">{{$cart['total']}} DH</div>
                </div>
                <form>
                    <p>SHIPPING</p>
                    <select>
                        <option class="text-muted">Standard-Delivery- 50.00 DH</option>
                    </select>

                </form>
                <div class="row" style="border-top: 1px solid rgba(0,0,0,.1); padding: 2vh 0;">
                    <div class="col">TOTAL PRICE</div>
                    <div class="col text-right">{{$cart['total']+150}} DH</div>
                </div>
